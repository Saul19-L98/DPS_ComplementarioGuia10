...
{
fetch('https://marketudb.000webhostapp.com/apiusuario.php?comando=autenticar
&usuario='+this.state.usuario+'&contrasena='+this.state.contrasena, {
method: 'GET'
})
...
this.cargarRegistros();
 ...
 />
 <Text
style={{fontSize:18,textAlign:'center',height:40,marginTop:10,backgroundColo
r:'lightgray',textAlignVertical:'center', 
...
fetch('https://marketudb.000webhostapp.com/api.php?comando=editar&nombre='+t
his.state.nombre
...
fetch('https://marketudb.000webhostapp.com/api.php?comando=eliminar&id='+thi
s.state.id, {
 method: 'GET'
 })
 .then((response) => response.json())
...
fetch('https://marketudb.000webhostapp.com/api.php?comando=agregar&nombre='+
this.state.nombre
 +'&descripcion='+this.state.descripcion
 +'&cantidad='+this.state.cantidad
 +'&preciodecosto='+this.state.preciodecosto
